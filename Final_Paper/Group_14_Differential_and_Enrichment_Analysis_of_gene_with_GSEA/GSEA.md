...
3. False Discovery Rate (FDR) <br>
   ...
   (2) the actual ES vs the ES of all gene sets against the actual dataset. [3] For example, if 6 gene sets were analyzed with 1000 permutations, the 2 resulting distributions would contain one with 6000 data points with second distribution containing 6. 
